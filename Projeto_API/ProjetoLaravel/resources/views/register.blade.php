  ...
  <section class="auth-form-side">
    <div class="auth-card">
      <div class="tabs" role="tablist">
        <button class="tab" role="tab" aria-selected="false" data-tab="entrar" id="tab-entrar">Entrar</button>
        <button class="tab is-active" role="tab" aria-selected="true" data-tab="cadastro" id="tab-cadastro">Cadastrar</button>
        <span class="tab-indicator"></span>
      </div>

      <form class="auth-form" id="form-entrar" method="POST" action="{{ url('/login') }}">
        @csrf
      ...
      <form class="auth-form is-active" id="form-cadastro" method="POST" action="{{ url('/registrar') }}">
        @csrf
